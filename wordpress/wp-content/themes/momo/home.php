                    ...
                    <div class="container-fluid  hero__accueil">
                        <div class="row d-flex">
                            <h1 class="hero__titre col-10 justify-content-center#">
                                C'est Promis une intégration sans problème
                            </h1>
                            <h2 class="hero__question col-12 d-none  d-md-block">Quelle est votre situation?</h2>
                            <h3 class="hero__option col-12 d-none d-md-block">
                                Sélectionnez l'une des options suivantes et découvrez des informations adaptées à vos besoins:
                            </h3>
                            <div class="row row__hero hero__button justify-content-center">
                                <button type="button" class="btn-1 col-lg-8 d-none d-md-block"><h5>J'ai un certificat de
                                    sélection du Québec</h5></button>
                                <button type="button" class="btn-2  col-lg-8 d-none d-md-block "><h5>Je suis une résidente
                                    permanente, un résident permanent</h5></button>
                                <button type="button" class="btn-3  col-lg-8 d-none d-md-block"><h5>Je suis une citoyenne
                                    naturalisée, un citoyen naturalisé</h5></button>
                                <button type="button" class="btn-4  col-lg-8 d-none d-md-block"><h5>Je suis travailleur
                                    autonome</h5></button>
                                <button type="button" class="btn-5  col-lg-8 d-none d-md-block"><h5>Je suis un étudiant
                                    international</h5></button>
                                <button type="button" class="btn-6  col-lg-8 d-none d-md-block "><h5>Je suis un réfugié, une
                                    réfugiée</h5></button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" rendez-vous__accueil--card col-lg-8 col-md-10 col-sm-12 justify-content-center  ">
                                <div class="rendez-vous__accueil--body card-body ">
                                    ...
                                    <div class="row rendez-vous__accueil--row">
                                        ...
                                        <h2 class="card-text rendez-vous__accueil--card-texte ">PRENEZ RENDEZ-VOUS AVEC UN CONSEILLER DÈS MAINTENANT!
                                        </h2>

                                        <h4>Les rencontres se font en personne ou en ligne par visioconférence, selon votre préférence. Service gratuit.</h4>

                                        <h5>Pour toute question, contactez-nous</h5>



                                        <button class="rendez-vous__accueil--bouton  col-lg-5 justify-content-center"><h4>Prendre
                                            un rendez-vous</h4>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12 col-lg-6 d-flex">
                                    <div class="evenement__card-body d-none d-md-block d-lg-block card-body">
                                        ...
                                        <h4 class="evenement__calendrier">Mercredi 15 novembre 2023</h4>

                                        <h4 class="evenement__heure">18h00 - 19h00</h4>

                                        <h4 class="evenement__prix">Gratuit</h4>

                                        <h4 class="evenement__lieu">Webinaire en ligne</h4>
    ...
    <section class="service">
        ...
        <div class="swiper swiperService d-lg-none">
            <div class="swiper-wrapper ">
                        ...
                        <div class="card-body ">
                            <div class="row ">
                                <a class="lien-titre" href="detail_service.html">
                                    <h3 class="card-title col-12">Accueil et Intégration</h3>
                                </a>

                            </div>
                            <a href="detail_service.html" class="lien">
                                <p class="card-text">Nos conseillers vous offrent un accompagnement personnalisé pour faciliter votre intégration et celle de votre famille à la société québécoise.</p>
                            </a>
                        </div>
              ...
              ---------------------------------------------------------->
                <div class="swiper-slide ">
                    <div class="card-2 carte-service  col-10 col-md-11 col-lg-6 card__francisation">
                        <div class="card-body ">
                            <div class="row">

                                <h3 class="card-title service-titre">Service de francisation</h3>


                            </div>

                            <p class="card-text">Maîtriser la langue officielle du Québec est essentiel pour vous épanouir pleinement sur votre lieu de travail et vous intégrer à la vie de la province. Gratuits, nos cours sont reconnus par le gouvernement et disponibles pour
                                tous les niveaux.</p>
                ...
                <!--famille
              ---------------------------------------------------------->
                <div class="swiper-slide d-lg-block">
                    <div class="card-3 carte-service  col-md-11 col-10 col-lg-6  card__famille">
                        <div class="card-body">
                            <div class="row">
                                <h3 class="card-title col-12 service-titre ">Soutien aux familles</h3>

                            </div>
                            <p class="card-text">Notre équipe organise régulièrement des sorties et activités ludiques pour permettre de s'imprégner et de s'impliquer dans la vie culturelle québécoise. Nous offrons aussi un service de soutien personnalisé aux familles selon
              ...
              ---------------------------------------------------------->
                <div class="swiper-slide ">
                    <div class="card-4 carte-service  col-10 col-md-11 col-lg-6 card__scolaire">
                        <div class="card-body ">
                            <div class="row">
                                <h3 class="card-title service-titre col-12 ">Soutien scolaire</h3>

                            </div>
                            <p class="card-text">Parce que l'école occupe une place importante dans l'intégration des jeunes immigrants, Promis offre un soutien scolaire pour les enfants du primaire et les jeunes du secondaire.</p>
              ...
              ---------------------------------------------------------->
                <div class="swiper-slide ">
                    <div class="card-5 carte-service col-10 col-md-11 col-lg-6 card__emplois">
                        <div class="card-body ">
                            <div class="row">
                                <h3 class="card-title col-12 service-titre">Aide à l'emplois</h3>

                            </div>
                            <p class="card-text">Notre service d'aide à l'emploi vous conseille dans vos démarches et vous prépare pour ce nouveau marché de l'emploi que vous découvrez. Notre équipe s'appuie sur un solide réseau de partenaires pour répondre à vos besoins.</p>
              ...
              ---------------------------------------------------------->
                ...
                <div class="swiper-slide">
                    <div class="card-7 carte-service col-10 col-md-11 col-lg-6 card__alimentation">
                        <div class="card-body ">
                            <div class="row">
                                <h3 class="card-title col-12 service-titre">Action Alimentaire</h3>

                            </div>
                            <p class="card-text">Nos ateliers et le jardin collectif de Promis vous permettent de cultiver différents fruits et légumes et d'étoffer votre livre de recettes. Vous avez aussi la possibilité de commander des boîtes de fruits et légumes frais
                                à juste prix!</p>
        ...
        <div class="container service__container service_ordi">
            ...
            <div class="row row__service ">
                ...
                <div class="card  service__accueil d-none  m-2 col-3 d-lg-block">
                    <div class="card-body ">
                        <div class="row ">
                            <h3 class="card-title accueil">Accueil et Intégration</h3>
                ...
                <div class="card service__francisation  m-2 col-3 d-none d-lg-block ">
                    <div class="card-body ">
                        <h3 class="card-title francisation">Service de francisation</h3>
                ...
                <div class="card service__famille m-2 col-3  d-none d-lg-block  ">
                    <div class="card-body ">
                        <h3 class="card-title famille">Soutien aux familles</h3>

                        <p class="card-text">Notre équipe organise régulièrement des sorties et activités ludiques pour permettre de s'imprégner et de s'impliquer dans la vie culturelle québécoise. Nous offrons aussi un service de soutien personnalisé aux familles selon les
                            besoins de chacun.</p>

                    </div>
                </div>
                <div class="card  service__scolaire m-2 d-none  col-3 d-lg-block">
                    <div class="card-body ">
                        <h3 class="card-title scolaire">Soutien scolaire</h3>

                        <p class="card-text">Parce que l'école occupe une place importante dans l'intégration des jeunes immigrants, Promis offre un soutien scolaire pour les enfants du primaire et les jeunes du secondaire.
                        </p>

                    </div>
                </div>
                <div class="card   service__emplois m-2 d-none   col-3 d-lg-block ">
                    <div class="card-body ">
                        <h3 class="card-title emplois">Aide à l'emplois</h3>

                        <p class="card-text">Notre service d'aide à l'emploi vous conseille dans vos démarches et vous prépare pour ce nouveau marché de l'emploi que vous découvrez. Notre équipe s'appuie sur un solide réseau de partenaires pour répondre à vos besoins.</p>

                    </div>
                </div>
                <div class="card service__alimentaire m-2  d-none col-3 d-lg-block">
                    <div class="card-body ">
                        <h3 class="card-title alimentaire">Action Alimentaire</h3>

                        <p class="card-text">Nos ateliers et le jardin collectif de Promis vous permettent de cultiver différents fruits et légumes et d'étoffer votre livre de recettes. Vous avez aussi la possibilité de commander des boîtes de fruits et légumes frais à juste
                            prix!
                        </p>
...
----------------------------------------->
  ...
  -------------------------------------->
                ...
                <div itemscope itemtype="https://schema.org/Article" class="swiper-slide">
                    <div class=" nouvelle__hebergement card-7 col-10 col-md-11 col-lg-6">
                        <div class="nouvelle card-body ">
                            ...
                            <h3 itemprop="title" class="card-title col-12">Un lieu d'hébergement pour les femmes</h3>


                            <h5 itemprop="datePublished" class="card-text"> 26 janvier 2021</h5>
        ...
        <a href="hub_nouvelle.html" class="d-flex"> <button class="btn-nouvelle justify-content-center"><h4>Voir toute les
                nouvelles</h4></button></a>
        <!--Pour ecran large col-12 
    ------------------------------------------------->
    </section>

    <section class="temoignage">
        <h2 class="temoignage__titre ">Témoignage</h2>
            ...
            <div class="card temoignage__card col-12 col-md-11 col-sm-12 justify-content-center  ">
                <div class="temoignage__body card-body ">
                    ...
                    <div class="row d-flex">
                        ...
                        <img class="card-image-top temoignage__image justify-content-center col-lg-3 col-md-11 col-sm-5" src="media/temoignage.jpg" alt="">



                        <h3 class="card-text temoignage__card-texte col-lg-7">“Propreté, accueil, tranquillité, sécurité, et confort vous attendent dans un décor sobre et reposant. Ceci était ma première expérience mais certainement pas la dernière.”</h3>
